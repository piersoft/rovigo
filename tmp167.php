...
var iframe=document.getElementById('mioIFRAME');
 if(iframe){
    var altezza = iframe.contentWindow.document.body.scrollHeight+30;
    iframe.height = altezza+"px";
 }
}
</script>
      <div id="loadImg">Caricamento...</br></br>

             <div><img src="ajax-loader3.gif" /></div></div>
         <iframe id="mioIFRAME" border=0 name=iframe src="oraripaline.php?sname=<?php
